 ...
 */
function login() {
    return location.href = "http://sso.huhavefun.com/page/login";
}
function regist() {
    return location.href = "http://sso.huhavefun.com/page/register";
}
...
function search(a) {
    var b = "http://www.huhavefun.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
